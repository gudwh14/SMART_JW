   ...
   <div class="container mt-3" style="max-width: 300px;">
      <form method="post" action="./LoginAction.jsp">
         <div class="form-group">
            ...
            <input type="text" style="width:200px; " name="Regist_Num" class="form-control">
         </div>
         <div class="form-group">
            <label>업체(기관)명</label>
            <input type="text" style="width:200px; " name="Enterprise_Name" class="form-control">
         </div>
         <div class="form-group">
            <label>대표자 성명</label>
            <input type="text" style="width:200px; " name="Leader_Name" class="form-control">
         </div>
         <div class="form-group">
            <label>사업자 등록증</label>
            <input type="text" style="width:200px; " name="Regist_Certificate" class="form-control">
            <input type="button" style="width:30px; height:30px;" name="Upload_Button" class="form-control" value="업로드">
         </div>
         <div class="form-group">
            <label>대표자 확인서</label>
            <input type="text" style="width:200px; " name="Leader_Certificate" class="form-control">
            <input type="button" style="width:30px; height:30px;" name="Upload_Button" class="form-control" value="업로드">
         </div>
      </form>      
   </div>
