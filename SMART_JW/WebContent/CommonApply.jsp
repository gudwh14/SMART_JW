	...
	<div style="width:350px; margin:0 auto; margin-top:20px">
		...
		<div class="form-group">
			<div class="form-inline">
				...
				<button type="submit" class="btn btn-primary" style="margin-left:10px; font-size:12px">선택</button>
			</div>
		</div>
	</div>
...
<!-- 대표자 확인 -->
	<div style="width:350px; margin:0 auto; margin-top:20px">
		<input type="checkbox" name="chk_info" value="M"> 대표자 확인
...
<!-- 개인정보 수집동의 -->
	<div class ="1" style="width:350px; margin:0 auto;">
		<input style="margin-top:20px;" type="checkbox" name="check" value="agree"> 개인정보 수집 및 이용에 대한 약관
...
<!-- 취소,다음 -->
	<div class="container mt-5 centor-block" style="max-width:300px display: inline-block;text-align: center;">
		...
		<button type="submit" class="btn btn-success btn-sm" style="margin-left:10px; width:100px">신청하기</button>
	</div>
